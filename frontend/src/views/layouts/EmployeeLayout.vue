      ...
      <div class="p-4 border-t border-gray-100">
        <div class="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-surface-50 mb-2">
          <div class="w-8 h-8 rounded-full bg-brand-100 flex items-center justify-center flex-shrink-0">
            <span class="text-sm font-semibold text-brand-700">{{ userInitial }}</span>
          </div>
          <div class="min-w-0">
...
const navItems = [
  ...
  { to: '/employee/apply', icon: '📝', label: 'Apply for Leave' },
  { to: '/employee/my-leaves', icon: '📋', label: 'My Leaves' }
]
